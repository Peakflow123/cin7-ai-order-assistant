        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link
              key={tab.href}
              href={tab.href}
              className={`mx-1 flex flex-1 flex-col items-center justify-center gap-1 rounded-xl py-2 text-[11px] font-semibold transition ${active ? 'bg-blue-50 text-blue-700' : 'text-slate-600'}`}
            >
