        ...
        messages: [
          {
            ...
            content: [
              {
                type: 'text',
                text: 'Extract all readable text from this image for order processing. Preserve product names, SKUs, quantities, PO numbers, customer names, addresses, dates, prices and any table-like structure. If no useful text is visible, say: No readable text found.'
              },
              {
                type: 'image_url',
